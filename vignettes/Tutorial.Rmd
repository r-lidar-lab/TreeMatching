...
<div style="
     ...
     ">
  <p style="margin:0;">
    Register the column that records a unique ID for each tree with `idname = ...` is not mandatory. It only provide extra graphical display and by ID results.
  </p>
</div>
...
plot(height_inventory, height_measured, asp = 1,
